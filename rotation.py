...
pygame.init()
screen = pygame.display.set_mode((850, 600), 0, 0)
pygame.display.set_caption("Rotation using transform module")

image = pygame.image.load("imgs/python-logo.png").convert_alpha()
image2 = image
a = 0
...
while True:
    ...
    screen.blit(image2, (400 - (image2.get_width() / 2), 300 - (image2.get_height() / 2)))
